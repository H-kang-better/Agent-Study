...
class RagClient:
    ...
    async def connect(self, server_script: str):
        ...
        params = StdioServerParameters(
            ...
            command="/Users/caojingkang/PycharmProjects/RAG_Project/rag_app/MCP实战/mcp-in-action/02-mcp-rag/rag-server/.venv/bin/python",
            args=[server_script],
        )
        # 2) 保存上下文管理器
...
async def main():
    ...
    client = RagClient()
    await client.connect("../rag-server/server-ali.py")
    print(">>> 系统连接成功")
